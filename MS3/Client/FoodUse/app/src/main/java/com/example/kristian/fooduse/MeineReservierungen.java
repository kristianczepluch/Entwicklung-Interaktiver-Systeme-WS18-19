...
public class MeineReservierungen extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meine_reservierungen);
        BottomNavigationView bottomNav = findViewById(R.id.bottom_navigation3);
        bottomNav.setOnNavigationItemSelectedListener(navListener);
        Menu menu = bottomNav.getMenu();
        MenuItem menuItem = menu.getItem(2);
        menuItem.setChecked(true);
        hamburgermenu_Btn = findViewById(R.id.reservierungen_hamburgermenu);
        drawerLayout = findViewById(R.id.drawer3);
        NavigationView sidebarNavigation = findViewById(R.id.meinereservierungen_sidebarnav);
